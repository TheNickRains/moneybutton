...
export default function ActivityLog({ colorScheme }: ActivityLogProps) {
  ...
  return (
    <motion.div 
      className="fixed left-4 top-32 bottom-20 w-64 rounded-lg overflow-hidden shadow-lg z-10 md:block"
      style={{ 
              ...
              <div className="text-xs mt-1">
                {activity.type === 'bet' && (
                  <div className="flex items-center flex-wrap">
                    ...
                    <span className="w-full opacity-60 text-xs">
                      (80% to pot, 20% to creator)
                    </span>
                  </div>
                )}
                ...
                {activity.type === 'win' && (
                  <div className="flex items-center">
                    ...
                    <span className="font-bold" style={{ color: colorScheme.accent }}>
                      Won the jackpot! {activity.amount} {activity.currency}
                    </span>
                  </div>
                )}
